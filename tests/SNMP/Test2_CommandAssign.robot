...
Wait Until Progress Bar Reaches 100 V2
    ...
    ${progress_bar_title_xpath}=    Set Variable    xpath=//div[contains(@class, 'p-progressbar')]
    Wait Until Page Contains Element    ${progress_bar_title_xpath}    timeout=3s
...
OR_AND Selection
    ...
    ELSE IF    "${input_output}" == "output"
        ...
        # Sleep    0.1s
    ELSE
        Fail    input_output text not recognized. Please select input or output.
    END
